...
def load_h5py_dataset(train_path,test_path):
    ...
    # Split/create the X and Y partm and transform to array
    train_set_x_orig = np.array(train_dataset["train_set_x"][:])
    train_set_y_orig = np.array(train_dataset["train_set_y"][:])

    # Read the test path + we split/create the X and Y partm and transform to array
    ...
    # Reshape the Y train and test datasets
...
# Create the forward propagation to predict function
